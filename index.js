...
(function ($) {
  ...
  $.fn.ribbon.defaults = {
    ...
    fadesteps: 0.1, // how many steps to fade the lines out by, reduce to optimize
    strokes: 20, // how many strokes to draw
    refreshRate: 5, // set this higher if performace is an issue directly affects easing
    easing: 0.7, // kind of "how loopy" higher= bigger loops
    brushSize: 3, // pixel width
